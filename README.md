...
Aqui você encontrará meus projetos, estudos e experimentos voltados para desenvolvimento de software.
...
**Back-end / Automação:**  
Python | Google Apps Script | Lógica de Programação | Estrutura de Dados  
